...
extends Entity {
    ...
    public boolean isOnLadder() {
        int k;
        int j;
        FastLadder fastLadder = (FastLadder)Client.moduleManager.moduleMap.get(FastLadder.class);
    ...
    private int getArmSwingAnimationEnd() {
        int speed;
        int n = speed = this instanceof EntityPlayerSP ? (int)(2.0f + (20.0f - Animation.INSTANCE.swingSpeed - 16.0f)) : 6;
    ...
    protected void jump() {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            Client.eventManager.onJump(event);
        }
