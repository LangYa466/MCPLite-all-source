...
public class PlayerControllerMP {
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        ...
        itemstack = playerIn.openContainer.slotClick(slotId, mouseButtonClicked, mode, playerIn);
        if (Disabler.INSTANCE.grimPost) {
            this.netClientHandler.addToSendQueue(new C0FPacketConfirmTransaction(windowId, (short) 0, true));
        }
        ...
        if (ViaLoadingBase.getInstance().getTargetVersion().isNewerThanOrEqualTo(ProtocolVersion.v1_17) && (slotId == -999 || mode == 4)) {
