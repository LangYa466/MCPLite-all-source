...
extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        Client.eventManager.onPreUpdate();
        ...
        Client.moduleManager.onPostUpdate();
        Disabler.INSTANCE.releaseTick();
    }

    public void onUpdateWalkingPlayer() {
        boolean flag1;
        MotionEvent preEvent = new MotionEvent(true, this.posY, this.rotationYaw, this.rotationPitch, this.onGround);
        Client.eventManager.onMotion(preEvent);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity == null) {
                ...
                } else if (ViaLoadingBase.getInstance().getTargetVersion().getOriginalVersion() == 47 || this.onGround != MovementUtils.lastOnGround || ClientSettings.INSTANCE.onHyt) {
        ...
        MotionEvent postEvent = new MotionEvent(false, this.posY, yaw, pitch, this.onGround);
        Client.eventManager.onMotion(postEvent);
    }
    ...
    public void onLivingUpdate() {
        ...
        if ((this.isUsingItem() || Gapple.eating) && !this.isRiding()) {
            SlowDownEvent event = SlowDownEvent.INSTANCE;
            event.slow();
            Client.eventManager.onSlowDown(event);
