...
IPlayerUsage {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn != null) {
            ...
            if (!(itemManager.getState() && itemManager.silent && (guiScreen instanceof GuiChest || guiScreen instanceof GuiFurnace || guiScreen instanceof GuiBrewingStand))) {
    ...
    private void sendClickBlockToController(boolean leftClick) {
        ...
        if (this.leftClickCounter <= 0 && (!this.thePlayer.isUsingItem() || BlockHit.INSTANCE.getState())) {
    ...
    private void clickMouse() {
        DelayRemover delayRemover = (DelayRemover)ModuleManager.getModuleByClass(DelayRemover.class);
        if (this.leftClickCounter <= 0) {
            this.thePlayer.swingItem();
            if (this.objectMouseOver == null) {
                logger.error("Null returned as 'hitResult', this shouldn't happen!");
                if (this.playerController.isNotCreative() && !delayRemover.click) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    default: {
                        if (!this.playerController.isNotCreative() || delayRemover.click) break;
                        this.leftClickCounter = 10;
                    }
                }
            }
    ...
    public void runTick() throws IOException {
        Disabler.postState = false;
        Client.eventManager.onTick();
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                while (this.gameSettings.keyBindAttack.isPressed()) {
                    BlockHit blockHit = (BlockHit)ModuleManager.getModuleByClass(BlockHit.class);
                    if (!blockHit.getState()) continue;
                    this.clickMouse();
                }
        ...
        if (this.thePlayer == null || this.thePlayer.isDead || this.thePlayer.getHealth() == 0.0f) {
            Disabler.INSTANCE.releaseTick();
        }
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        if (worldClientIn == null) {
            Client.eventManager.onWorldLoad();
