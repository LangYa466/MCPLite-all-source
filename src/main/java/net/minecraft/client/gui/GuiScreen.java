...
implements GuiYesNoCallback {
    ...
    public void sendChatMessage(String msg, boolean addToChat) {
        MessageSendEvent messageEvent = new MessageSendEvent(msg, addToChat);
        Client.eventManager.onMessageSend(messageEvent);
        msg = messageEvent.message;
        addToChat = messageEvent.addToChat;
        if (addToChat) {
