...
import client.ui.button.ClickGuiButton;
...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Super Secret SettingsButton..."){
        ...
        this.buttonList.add(new ClickGuiButton(201, this.width / 2 - 155, this.height / 6 + 168 - 6, 150, 20, this));
        this.buttonList.add(new GuiButton(200, this.width / 2 + 5, this.height / 6 + 168 - 6, 150, 20, I18n.format("gui.done", new Object[0])));
    }
