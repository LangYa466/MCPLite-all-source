...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, EnumChatFormatting.GRAY.toString() + EnumChatFormatting.BOLD + "Version Information", (this.width - this.fontRendererObj.getStringWidth("Version Information")) / 2, fixedHeight, -1);
